<template>
  <div class="card flex justify-between p-0 mb-4">
    <div>
      <RouterLink
        to="/"
        type="button"
        class="inline-flex w-44 h-30 p-0 items-center justify-center surface-0 dark:surface-800 border border-surface-200 dark:border-surface-600 rounded"
      >
      <img class="object-cover h-full w-full" src="@/assets/logo.png" alt="logo">
        <!-- <i class="pi pi-home dark:text-white"></i> -->
      </RouterLink>
    </div>
...
import ButtonCart from "./atoms/ButtonCart.vue";
